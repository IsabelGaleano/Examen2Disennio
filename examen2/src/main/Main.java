...
//        String query1 = "INSERT into avanceUsuarioFReto (idUsuarioF, idReto, nombreHito) VALUES (" + tmpAvance.getIdUsuario() + ", " + tmpAvance.getIdReto() + ",'" + tmpAvance.getNombreHito() + "')";
        ...
        String connectionUrl1 = "jdbc:mysql://localhost/bddisennio?user=root&password=Hola123";
...
//        stmt1.execute(query1);
        ...
        ResultSet rs2 = null;
        String idUsuario = "1";
        String connectionUrl2 = "jdbc:mysql://localhost/bddisennio?user=root&password=Hola123&useSSL=false";
